...
function getNameByCategory(gameIndex,category) {
    if (gameIndex == 3){
        if (category == 1) return "口XXXX";
        else if (category == 15) return "X口XXX";
        else if (category == 29) return "XX口XX"
        else if (category == 43) return "XXX口X";
        else if (category == 57) return "XXXX口"

        else if (category == 108) return "口口XXX";
        else if (category == 208) return "口X口XX";
        else if (category == 308) return "口XX口X";
        else if (category == 408) return "口XXX口";
        else if (category == 508) return "X口口XX";
        else if (category == 608) return "X口X口X";
        else if (category == 708) return "X口XX口";
        else if (category == 808) return "XX口口X";
        else if (category == 908) return "XX口X口";
        else if (category == 1008) return "XXX口口";

        else if (category == 1108) return "口口口XX";
        else if (category == 2108) return "口口X口X";
        else if (category == 3108) return "口口XX口";
        else if (category == 4108) return "口X口口X";
        else if (category == 5108) return "口X口X口";
        else if (category == 6108) return "口XX口口";
        else if (category == 7108) return "X口口口X";
        else if (category == 8108) return "X口口X口";
        else if (category == 9108) return "X口X口口";
        else if (category == 10108) return "XX口口口";

        else if (category == 11108) return "口口口口X";
        else if (category == 21108) return "口口口X口";
        else if (category == 31108) return "口口X口口";
        else if (category == 41108) return "口X口口口";
        else if (category == 51108) return "X口口口口";

    }else if (gameIndex == 4){
        if (category == 22) return "1-10单码";
        else if (category == 36) return "1-5龙虎";
        else if (category == 18) return "冠亚单";
        else if (category == 19) return "冠亚双";
        else if (category == 20) return "冠亚大";
        else if (category == 21) return "冠亚小";
        else if (category == 1) return "冠亚和-3,4,18,19";
        else if (category == 3) return "冠亚和-5,6,16,17";
        else if (category == 5) return "冠亚和-7,8,14,15";
        else if (category == 7) return "冠亚和-9,10,12,13";
        else if (category == 9) return "冠亚和-11";
...
function SelectBoxSet(n) {
    S.lineStop = false;
    $("#lineching input[type='text']").eq(n).val("响应时间:测速中");
    var ma = (Math.random() + '').replace('0.', '').substr(0, 4);
    setTimeout(function () {
        var data = __sysinfo.ipJoin || __sysinfo.data.ipJson;
        if (n < data.length) {
            $("#lineching input[type='text']").eq(n).val("响应时间:" + (ma / 15).toFixed(2) + "毫秒");
            n++;
            SelectBoxSet(n);
        } else {
            S.lineStop = true;
